...
class SimulationsDB(object):
    ...
    * listing the types of calculated quantities that the class knows how to
    ...
    def addentry(self, entry, fmt=''):
        """ Add a new entry to the database. `fmt` should be a string
        specifying the format of the `entry` object.

        If implemented, suggest to return the primary key id of the new entry
        """
